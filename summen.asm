...
; forutsatt at summen er mindre enn 19.
...
section .data
    meld db "Skriv to ensifrede tall skilt med mellomrom.",cr,lf
         db "Summen av tallene må være mindre enn 19.",cr,lf
    meldlen equ $ - meld
...
skrivsiffer:
    ...
    jb Skrivtall
    mov ebx, ecx
    mov ecx, 1 ; Flytter inn 1 på ecx
    call skrivsiffer
    sub ebx,10
    mov ecx, ebx
    ...
    mov [siffer],ecx
    mov ecx, siffer ; flytter siffer inn i ecx og tar modulo divisjon
    mov edx,1 ; lengde
    mov ebx,STDOUT
    mov eax,SYS_WRITE
    int 80h
